...
function CompanyCard({ company }: { company: PortfolioCompany }) {
  return (
    <a
      ...
      className={`group/card block rounded-xl border bg-white/60 p-5 transition-all hover:shadow-md hover:border-primary/20 h-[170px] flex flex-col ${
    ...
    >
      ...
      <div className="text-center flex-1 flex flex-col justify-start">
        <h3 className="font-semibold text-base group-hover/card:underline">{company.name}</h3>
        {company.tagline && (
